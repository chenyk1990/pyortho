...
The following figure shows a 2D denoising example using the pyortho package. Generated by [demos/test_pyortho_localortho2d.py](https://github.com/chenyk1990/pyortho/tree/main/demos/test_pyortho_localortho2d.py)
<img src='https://github.com/chenyk1990/gallery/blob/main/matortho/test_localortho2d.png' alt='comp' width=960/>

The following figure shows a 3D denoising example using the pyortho package. Generated by [demos/test_pyortho_localortho3d.py](https://github.com/chenyk1990/pyortho/tree/main/demos/test_pyortho_localortho3d.py)
